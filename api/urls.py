...
urlpatterns = [
    ...
    path('tasks/user/<int:user_id>/', tasks_by_user, name='tasks-by-user'),
    ...
    path('tasks_by_id/<int:task_id>/comments/<int:comment_id>/likes/', CommentLikesView.as_view(), name='comment-likes'),
    ...
    # path('api/tasks/<int:task_id>/likes/', task_likes, name='task-likes'),
    path('tasks/<int:task_id>/users_who_liked/', users_who_liked_task, name='users_who_liked_task'),
    path('tasks/<int:task_id>/users_who_shared/', users_who_shared_task, name='users-who-shared'),
